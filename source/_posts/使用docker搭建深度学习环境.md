...
![阿里云容器hub](使用docker搭建深度学习环境/阿里云.PNG)
...
![修改daemon.json](使用docker搭建深度学习环境/修改daemon.json.PNG)
...
![8.0-cudnn5-devel-ubuntu16.04](使用docker搭建深度学习环境/8.0-cudnn5-devel-ubuntu16.04.PNG)
...
构建结果：
![构建结果](使用docker搭建深度学习环境/构建结果.PNG)
